...
<!-- <h1>Doctor Information</h1>
 --><!-- <%
  Connection connection = null;
   ...
   String sql="select * from appointment_table where id=2";
   try{
...
<table>
 ...
 <select>
 <!--  -->
  <option value="mon1">Mon 1 PM - 2 PM</option>
  <option value="mon2">Mon 2 PM - 3 PM</option>
  <option value="mon3">Mon 3 PM - 4 PM</option>
  <option value="wed1">Wed 1 PM - 2 PM</option>
  <option value="wed2">Wed 2 PM - 3 PM</option>
</select> 
