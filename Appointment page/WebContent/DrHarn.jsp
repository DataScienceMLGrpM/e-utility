...
<!-- <h1>Doctor Information</h1>
 --><!-- <%
  Connection connection = null;
   ...
   String sql="select * from appointment_table where id=3";
   try{
...
<table>
 ...
 <select>
  <option value="mon1">Tue 9 AM - 10 AM</option>
  <option value="mon2">Tue 10 AM - 11 AM</option>
  <option value="mon3">Tue 11 AM - 12 PM</option>
  <option value="wed1">Thu 2 PM - 3 PM</option>
  <option value="wed2">Thu 3 PM - 4 PM</option>
</select> 
 </td>
 </tr>
 </table>
