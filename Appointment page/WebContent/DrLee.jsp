...
<!-- <h1>Doctor Information</h1>
 --><!-- <%
  Connection connection = null;
   ...
   String sql="select * from appointment_table where id=1";
   try{
...
<table>
 ...
 <select>
  <option value="tue3">Tue 9 AM - 10 AM</option>
  <option value="tue2">Tue 10 AM - 11 AM</option>
  <option value="tue1">Tue 11 AM - 12 PM</option>
  <option value="thu1">Thu 3 PM - 4 PM</option>
  <option value="thu2">Thu 4 PM - 5 PM</option>
</select> 
